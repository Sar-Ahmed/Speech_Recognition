...
__all__ = [ 'OLE_XSIZE_PIXELS', 'StdPicture', 'Checked',
           'OLE_TRISTATE', 'FONTITALIC', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_CONTAINER', 'Color',
           'IPictureDisp', 'FONTSTRIKETHROUGH', 'FONTSIZE',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_CANCELBOOL', 'OLE_HANDLE',
           'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'LoadPictureConstants', 'OLE_XPOS_PIXELS', 'FONTNAME',
           'OLE_YSIZE_CONTAINER', 'IFontDisp', 'IFontEventsDisp',
           'FontEvents', 'Gray', 'OLE_YPOS_CONTAINER', 'IPicture',
           'StdFont', 'Unchecked', 'Monochrome', 'Picture', 'Default',
           'IFont', 'OLE_YPOS_HIMETRIC', 'OLE_COLOR',
           'OLE_OPTEXCLUSIVE', 'Font', 'FONTUNDERSCORE', 'FONTBOLD',
           'OLE_YSIZE_PIXELS', 'OLE_YPOS_PIXELS', 'VgaColor']
from comtypes import _check_version; _check_version('1.1.11', 1622894692.6530693)
